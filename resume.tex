...
\begin{tabular}{rl}
%$\cdot$ & Project-based curriculum with no teachers or classes \\
%$\cdot$ & Peer-to-peer learning: we all teach and learn from each other \\
%$\cdot$ & Programming languages (\textsc{C/C++, Bash, Python, Asm, Java}, etc) \\
%$\cdot$ & Develops interpersonal skills through group work and peer corrections \\
%$\cdot$ & Forms solid time management and motivational skills \\
%$\cdot$ & Expected completion in 3-5 years \\
%$\cdot$ & New -- \\
